...
class AppStrings {
  ...
  static String get english => _t('English', 'ইংরেজি');
  ...
  static String get enrolledCourses => _t('Enrolled Courses', 'নিবন্ধিত কোর্স');
  static String get subjects => _t('subjects', 'বিষয়');
  static String get viewInPlanner => _t('View in Planner', 'পরিকল্পনায় দেখুন');
  ...
  // ── Notifications page ─────────────────────────────────────────────────
  static String get notificationCenter => _t('Notifications', 'নোটিফিকেশন');
  static String get markAllRead => _t('Mark all as read', 'সব পড়া হয়েছে');
  static String get notificationsOffTitle =>
      _t('Notifications are off', 'নোটিফিকেশন বন্ধ আছে');
  static String get notificationsOffBody => _t(
    'Turn them on to get deadline, streak and budget alerts.',
  ...
  // ── Common quick links ─────────────────────────────────────────────────
  static String get habitTracker => _t('Habit Tracker', 'অভ্যাস ট্র্যাকার');
  static String get checkTodayProgress =>
      _t('Check today\'s progress', 'আজকের অগ্রগতি দেখুন');
  static String get expenseManager => _t('Expense Manager', 'ব্যয় ব্যবস্থাপক');
  ...
  static String get backHome => _t('Back to home overview', 'হোমে ফিরে যান');
  ...
  static String get plannerSubtitle => _t(
    'Plan clearly. Study consistently.',
    'পরিষ্কার পরিকল্পনা, ধারাবাহিক পড়া।',
  );
  ...
  static String get overviewEmpty => _t(
    'Add a task to start your week.',
    'সপ্তাহ শুরু করতে একটি কাজ যোগ করুন।',
  );
  static String tasksCompleted(int completed, int total) => _t(
  ...
  static String get notesOptional => _t('Notes (optional)', 'নোট (ঐচ্ছিক)');
  ...
  static String get pastTasksReadOnlyDelete => _t(
    'Past tasks are read-only and cannot be deleted.',
  ...
  static String get deleteTaskQuestion => _t('Delete task?', 'কাজটি মুছবেন?');
  static String deleteTaskBody(String title) => _t(
    '“$title” will be permanently removed.',
    '“$title” স্থায়ীভাবে মুছে যাবে।',
  );
  static String get addSmartSuggestions =>
      _t('Add smart suggestions?', 'স্মার্ট পরামর্শ যোগ করবেন?');
  static String get smartSuggestionsBody => _t(
  ...
  static String get weekUpdated => _t(
    'Your week has been updated with available study blocks.',
    'আপনার সপ্তাহ উপলব্ধ স্টাডি ব্লক দিয়ে আপডেট হয়েছে।',
  );
  static String get couldNotGenerate => _t(
  ...
  static String get couldNotLoad => _t(
  ...
  static String get subSe =>
      _t('Software Engineering', 'সফটওয়্যার ইঞ্জিনিয়ারিং');
  ...
  static String get mockTask1Note => _t(
    'Focus on 3NF and BCNF examples.',
    '৩এনএফ ও বিসিএনএফ উদাহরণে ফোকাস করুন।',
  );
  static String get mockTask2 =>
      _t('Data mining practice', 'ডেটা মাইনিং অনুশীলন');
  static String get mockTask2Note => _t(
    'Complete two clustering problems.',
    'দুটি ক্লাস্টারিং সমস্যা সমাধান করুন।',
  );
  ...
  static String get mockGenNote => _t(
    'Suggested from your course load and available time.',
  ...
  static String get habitSubtitle => _t(
    'Small daily habits, a stronger you.',
    'ছোট দৈনিক অভ্যাস, শক্তিশালী আপনি।',
  );
  static String get yourHabits => _t('Your Habits', 'আপনার অভ্যাস');
  static String get habitStreaks => _t('Habit Streaks', 'অভ্যাস স্ট্রিক');
  static String get weeklyAnalytics =>
      _t('Weekly Analytics', 'সাপ্তাহিক বিশ্লেষণ');
  ...
  static String get thresholdScreenHigh => _t(
    'Screen time cannot exceed 24 hours in a single day.',
  ...
  static String get habitWaterIntake => _t('Water Intake', 'পানি গ্রহণ');
  static String get habitScreenTime => _t('Screen Time', 'স্ক্রিন সময়');
  static String get hydration => _t('Hydration', 'পানি');
  static String logTitle(String name) => _t('Log $name', 'লগ করুন $name');
  static String todaysValue(String unit) =>
      _t('Today\'s value ($unit)', 'আজকের মান ($unit)');
  static String egValue(String target) => _t('e.g. $target', 'যেমন: $target');
  static String get saveEntry => _t('Save entry', 'এন্ট্রি সংরক্ষণ');
  static String checkedInStreak(int day) => _t(
    'Checked in! Day $day streak · +10 pts',
  ...
  static String get sleepInsightTag => _t('Sleep pattern', 'ঘুমের ধরণ');
  static String get sleepInsight => _t(
    'You slept below 6 hours for 3 consecutive days. Try winding down 30 minutes earlier tonight.',
    'টানা ৩ দিন আপনি ৬ ঘণ্টার কম ঘুমিয়েছেন। আজ রাতে ৩০ মিনিট আগে ঘুমাতে যাওয়ার চেষ্টা করুন।',
  );
  static String get screenInsightTag => _t('Screen time', 'স্ক্রিন সময়');
  static String get screenInsight => _t(
    'Your screen time increased noticeably this week, especially around exam days.',
  ...
  static String get stressInsight => _t(
    'Staying consistent with exercise this week helped lower your predicted stress score.',
  ...
  static String get nothingLogged => _t(
  ...
  static String youSaved(String amount) => _t(
    'You saved $amount in this period.',
    'এই সময়ে আপনি $amount সাশ্রয় করেছেন।',
  );
  static String youOverspent(String amount) => _t(
    'You overspent by $amount in this period.',
  ...
  static String get addTypeSubtitle => _t(
    'Track where your money goes and where it comes from.',
  ...
  static String get expenseCategory => _t('Expense category', 'ব্যয় বিভাগ');
  static String get incomeSource => _t('Income source', 'আয়ের উৎস');
  static String get noteOptional => _t('Note (optional)', 'নোট (ঐচ্ছিক)');
  static String get noteHint => _t(
    'e.g. Canteen lunch with friends',
    'যেমন: বন্ধুদের সাথে ক্যান্টিনে লাঞ্চ',
  );
  ...
  static String get overBudgetMessage => _t(
    'You\'ve spent more than your budget this month.',
    'এই মাসে বাজেটের বেশি খরচ হয়েছে।',
  );
  static String thisWeekCaption(String label) =>
      _t('This week · $label', 'এই সপ্তাহ · $label');
  static String yearCaption(String year) => _t('Year $year', 'বছর $year');
  ...
  // ── Assistant page ─────────────────────────────────────────────────────
  static String get assistantTitle => _t('Twinny Assistant', 'টুইনি সহকারী');
  static String get assistantSubtitle => _t(
    'Ask me anything about your studies',
    'আপনার পড়াশোনা নিয়ে যেকোনো প্রশ্ন করুন',
  );
  ...
  static String get askAnythingSubtitle => _t(
    'Study tips, deadline help, stress advice…',
    'স্টাডি টিপস, ডেডলাইন সাহায্য, চাপ নিয়ে পরামর্শ…',
  );
  static String assistantGreeting(String name) => _t(
    'Hi $name! I\'m your Twinny assistant. How can I help you today?',
    'হাই $name! আমি আপনার টুইনি সহকারী। আজ কীভাবে সাহায্য করতে পারি?',
  );
  static String get assistantReply1 => _t(
  ...
  static String get assistantReply2 => _t(
  ...
  static String get assistantReply5 => _t(
  ...
  // ── App Blocker page ───────────────────────────────────────────────────
  static String get selectAppFirst => _t(
  ...
  static String focusActiveSub(int count, int minutes) => _t(
    '$count app(s) blocked · $minutes min session',
    '$countটি অ্যাপ ব্লক করা · $minutes মিনিট সেশন',
  );
  static String get focusOffSub => _t(
  ...
  static String minutes(int minutes) => _t('$minutes min', '$minutes মিনিট');
  ...
  static String get selectDuration =>
      _t('Select Duration', 'সময়কাল নির্বাচন করুন');
  ...
  static String get heroBody => _t(
    'CampusTwin unifies your studies, habits, stress and expenses into one AI-powered system — so it can guide you, not just track you.',
  ...
  static String get signInContinue => _t(
  ...
  static String get signInCardTitle => _t('Welcome back', 'ফিরে আসায় স্বাগতম');
  static String get signInCardSubtitle => _t(
  ...
  static String get universityEmail => _t('Email', 'ইমেইল');
  static String get emailHint => _t('user@gmail.com', 'user@gmail.com');
  ...
  static String get createAccountHero =>
      _t('Create account', 'অ্যাকাউন্ট তৈরি করুন');
  static String get setStudentProfile => _t(
  ...
  static String get fastOnboarding => _t('Fast onboarding', 'দ্রুত অনবোর্ডিং');
  static String get privateProfile => _t('Private profile', 'গোপনীয় প্রোফাইল');
  static String get createAccountCardTitle =>
      _t('Create your account', 'আপনার অ্যাকাউন্ট তৈরি করুন');
  static String get completeForm => _t(
  ...
  static String get nameHint => _t('username', 'username');
  ...
  static String get passwordHelper => _t(
  ...
  static String get authUserNotFound => _t(
    'No account found with this email.',
    'এই ইমেইলে কোনো অ্যাকাউন্ট পাওয়া যায়নি।',
  );
  static String get authWrongPassword => _t(
    'Incorrect password. Please try again.',
    'পাসওয়ার্ড সঠিক নয়। আবার চেষ্টা করুন।',
  );
  ...
  static String get authFailed => _t(
  ...
  static String get sendResetLink => _t('Send Reset Link', 'রিসেট লিংক পাঠান');
